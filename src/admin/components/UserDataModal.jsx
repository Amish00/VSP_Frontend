...
const UserDataModal = ({ isOpen, onClose, user, onUserUpdated, currentUserRole, currentUserId }) => {
    ...
    const [selectedFile, setSelectedFile] = useState(null);  // NEW: pending file
    ...
    useEffect(() => {
        if (user) {
            ...
            setSelectedFile(null);  // clear any pending file
        }
    }, [user]);
    ...
    // Only create a local preview, do NOT upload yet
    const handleFileChange = (e) => {
        ...
        // Create local preview and store the file
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // 2. Update user details (username, role, plan, status, etc.)
