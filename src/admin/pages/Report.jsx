// client/src/pages/admin/Report.jsx
...
const Report = () => {
    ...
    const fetchEarningsReport = async () => {
        setLoading(true);
        try {
            // This would need a backend endpoint to get all creators' earnings summary
            // For now, we'll use placeholder - but you can implement /api/admin/earnings/all
    ...
    const fetchPayoutsReport = async () => {
        ...
        try {
            ...
            // Also get processed payouts if needed
