...
const VideoTable = ({ videos = [], onEdit }) => {
  if (videos.length === 0) {
                ...
                <td className="px-4 py-3">
                  <div className="flex gap-1.5">
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-primary/10 text-primary-light text-xs font-semibold hover:bg-primary/20 transition-colors"
                    >
                      Edit
                    </button>
