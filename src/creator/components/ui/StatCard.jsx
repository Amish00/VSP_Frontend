...
const StatCard = ({ icon, label, value, change, color }) => {
    return (
        <div className="card-hover p-6 rounded-2xl bg-bg-card border border-border cursor-default" style={{ boxShadow: '0 2px 12px rgba(0,0,0,.3), inset 0 1px 0 rgba(255,255,255,.03)' }}>
