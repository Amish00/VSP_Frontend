...
const UploadPage = () => {
  ...
  // Reset everything after successful upload (or when user chooses "Upload Another")
  const resetForm = () => {
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_360px] gap-6">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-bg-card border border-border rounded-2xl p-6">
            ...
            <Toggle
              value={form.paid}
              onChange={v => upd('paid', v)}
              label="Paid content"
              desc="Require an active subscription to watch this video"
            />
          </div>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div className="bg-bg-card border border-border rounded-2xl p-6">
            ...
            >
              ...
              {thumb && (
                <button
                  onClick={e => { e.stopPropagation(); setThumb(null); setThumbFile(null); }}
